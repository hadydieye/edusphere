      ...
      <div className="mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {parentsData.map((parent) => (
            <div key={parent.id} className="bg-gray-800 p-4 rounded-lg">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-400">{parent.phone}</p>
                </div>
              </div>
              <div className="mt-4">
                <p className="text-sm text-gray-300">
                  <strong>Enfants:</strong> {parent.students.join(", ")}
                </p>
                <p className="text-sm text-gray-300">
                  <strong>Adresse:</strong> {parent.address}
                </p>
              </div>
