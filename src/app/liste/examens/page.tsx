            ...
            <div key={exam.id} className="bg-gray-800 p-4 rounded-lg">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-400">Classe {exam.class}</p>
                </div>
              </div>
              <div className="mt-4">
                <p className="text-sm text-gray-300">
                  <strong>Enseignant:</strong> {exam.teacher}
                </p>
                <p className="text-sm text-gray-300">
                  <strong>Date:</strong> {new Date(exam.date).toLocaleDateString('fr-FR')}
                </p>
              </div>
